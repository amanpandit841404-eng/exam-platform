      ...
      return (
        <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0088cc 0%, #005580 100%)", fontFamily: "sans-serif", display: "flex", alignItems: "center", justifyContent: "center", padding: "16px" }}>
          <div style={{ maxWidth: "420px", width: "100%", textAlign: "center" }}>
            ...
            <a
              href="/"
              style={{ display: "block", background: "rgba(255,255,255,0.15)", color: "#fff", borderRadius: "12px", padding: "12px 24px", textDecoration: "none", fontSize: "14px", fontWeight: "600" }}
            >
              ← Back to Website
            </a>
