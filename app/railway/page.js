...
export default function Railway() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: bg, fontFamily: "sans-serif", paddingBottom: 80 }}>
      <div style={{ background: "linear-gradient(135deg,#7c2d12,#c2410c)", padding: "18px 16px 16px", color: "#fff" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ fontSize: 13, opacity: 0.9 }}>🚂 भारतीय रेलवे भर्ती</div>
          <h1 style={{ margin: "6px 0", fontSize: 24, fontWeight: 800 }}>Railway Exams Center</h1>
          <div style={{ fontSize: 13, opacity: 0.92, lineHeight: 1.5 }}>
            RRB NTPC, Group D, ALP, JE, RPF — सभी रेलवे exams की पूरी जानकारी एक जगह। Posts, Eligibility, Exam Pattern, Syllabus और Salary।
          </div>
        </div>
      </div>
