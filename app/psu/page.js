...
export default function PSU() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: bg, fontFamily: "sans-serif", paddingBottom: 80 }}>
      <div style={{ background: "linear-gradient(135deg,#164e63,#06b6d4)", padding: "18px 16px 16px", color: "#fff" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ fontSize: 13, opacity: 0.9 }}>🏭 सार्वजनिक उपक्रम भर्ती</div>
          <h1 style={{ margin: "6px 0", fontSize: 24, fontWeight: 800 }}>PSU Exams Center</h1>
          <div style={{ fontSize: 13, opacity: 0.92, lineHeight: 1.5 }}>
            IOCL, ONGC, BHEL, NTPC, SAIL, GAIL, BEL — सभी PSU exams की पूरी जानकारी एक जगह। Posts, Eligibility, Exam Pattern, Salary।
          </div>
        </div>
      </div>
