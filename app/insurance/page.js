...
export default function Insurance() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: bg, fontFamily: "sans-serif", paddingBottom: 80 }}>
      <div style={{ background: "linear-gradient(135deg,#4c1d95,#8b5cf6)", padding: "18px 16px 16px", color: "#fff" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ fontSize: 13, opacity: 0.9 }}>🛡️ बीमा कंपनी भर्ती</div>
          <h1 style={{ margin: "6px 0", fontSize: 24, fontWeight: 800 }}>Insurance Exams Center</h1>
          <div style={{ fontSize: 13, opacity: 0.92, lineHeight: 1.5 }}>
            LIC ADO, NIACL AO, NICL AO, UIIC, IRDAI, GIC — सभी insurance exams की पूरी जानकारी एक जगह। Posts, Eligibility, Exam Pattern, Salary।
          </div>
        </div>
      </div>
