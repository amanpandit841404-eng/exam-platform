...
export default function Defence() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: bg, fontFamily: "sans-serif", paddingBottom: 80 }}>
      <div style={{ background: "linear-gradient(135deg,#134e4a,#14b8a6)", padding: "18px 16px 16px", color: "#fff" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ fontSize: 13, opacity: 0.9 }}>🪖 भारतीय रक्षा बल भर्ती</div>
          <h1 style={{ margin: "6px 0", fontSize: 24, fontWeight: 800 }}>Defence Exams Center</h1>
          <div style={{ fontSize: 13, opacity: 0.92, lineHeight: 1.5 }}>
            Agniveer (Army/Vayu/Navy), AFCAT, INET, Coast Guard — सभी defence exams की पूरी जानकारी एक जगह। Posts, Eligibility, Exam Pattern, Syllabus और Salary।
          </div>
        </div>
      </div>
